...
export const CTA1 = () => (
  <div className="w-full py-8 lg:py-14 relative flex justify-center items-center">
    ...
    <div className="relative z-10 w-full max-w-3xl mx-auto flex flex-col items-center text-center gap-4 px-2 py-6 lg:py-10">
      <div>
        <Badge className="bg-red-600 text-white text-base px-4 py-2">Comienza ahora</Badge>
      </div>
      ...
      <div className="flex flex-row gap-2 justify-center w-full">
        <Button className="gap-4 bg-white text-red-600 border-2 border-red-600 hover:bg-red-50" variant="outline" asChild>
          <a href="https://wa.me/573103662934" target="_blank" rel="noopener noreferrer">Contáctanos</a>
        </Button>
        <Button className="gap-4 bg-red-600 text-white hover:bg-red-700" asChild>
